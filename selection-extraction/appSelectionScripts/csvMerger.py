...
github_file_path = './github_12_02_2016.csv'
wikipedia_file_path = './wikipedia_11_02_2016.csv'
froid_file_path = './fdroid_11_02_2016.csv'

# the path to the file to be created containing the list of apps and projects
filePath = 'merged_' + '12_02_2016' +'.csv'
